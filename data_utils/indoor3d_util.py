...
g_classes = ['background', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow',
...
#                  'board':       [200,200,200],
#                  'clutter':     [50,50,50]}
g_class2color = {'background': [0, 255, 0],
                 'aeroplane': [0, 0, 255],
                 'bicycle': [0, 255, 255],
                 'bird': [255, 255, 0],
                 'boat': [255, 0, 255],
                 ...
                 'chair': [200, 100, 100],
                 'cow': [10, 200, 100],
                 'diningtable': [200, 200, 200],
                 'dog': [50, 50, 50],
                 'horse': [40, 70, 80],
                 'motorbike': [80, 70, 20],
                 'person': [10, 80, 90],
                 'pottedplant': [100, 200, 0],
                 'sheep': [200, 100, 0],
                 'sofa': [200, 0, 100],
                 'train': [200, 0, 0],
                 'tvmonitor': [0, 0, 0]}
