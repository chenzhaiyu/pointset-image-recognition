...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='temp', help='Log path [default: None]')
    ...
    # parser.add_argument('--data_dir', type=str, default='/media/zhaiyu/7CF2DC06F2DBC296/Datasets/stanford_indoor3d', help='Data dir')
...
def main(args):
    ...
    TRAIN_DATASET = S3DISDataset(split='train', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=None, use_block=False, num_class=args.num_class)
    print("start loading test data ...")
    TEST_DATASET = S3DISDataset(split='test', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=None, use_block=False, num_class=args.num_class)
